...
fn main(){
   ...
   let staffnumber:u32 = 0;
   for mut staffnumber in 0..=100{
   ...
   let papers_published:u32 = input1.trim().parse().expect("Not a valid number");

   let incentive = if papers_published >= 3 && <5 {  
            500_000
        } else if papers_published >5 && <10 {
            800_000
